...
public class Main {
	...
	public static void main(String[] args) {
		...
		User player1 = new Player(1, "1000", "Tolgahan", "Öztürk", "100000000", new GregorianCalendar(1993,11,16).getTime());
		User player2 = new Player(2, "1001", "Kadir", "Kadir", "10000000", new GregorianCalendar(1995,1,1).getTime());
